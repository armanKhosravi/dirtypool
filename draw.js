...
function simulate() {
	...
	var lBadge = (100 * lCrt1 / hCrt1 - 100) >= 0 ? 'If (&alpha;,&gamma;) = (' + a + ',' + g + ') LEAD strategy would be ' + (100 * lCrt1 / hCrt1 - 100).toFixed(1) + ' %' + ' MORE profitable than being HONEST.' : 'If (&alpha;,&gamma;) = (' + a + ',' + g + ') LEAD strategy would be ' + (100 - 100 * lCrt1 / hCrt1).toFixed(1) + ' %' + ' LESS profitable than being HONEST.';
	var t2Badge = (100 * t2Crt1 / hCrt1 - 100) >= 0 ? 'If (&alpha;,&gamma;) = (' + a + ',' + g + ') 2-TRAIL strategy would be ' + (100 * t2Crt1 / hCrt1 - 100).toFixed(1) + ' %' + ' MORE profitable than being HONEST.' : 'If (&alpha;,&gamma;) = (' + a + ',' + g + ') 2-TRAIL strategy would be ' + (100 - 100 * t2Crt1 / hCrt1).toFixed(1) + ' %' + ' LESS profitable than being HONEST.';
	var t3Badge = (100 * t3Crt1 / hCrt1 - 100) >= 0 ? 'If (&alpha;,&gamma;) = (' + a + ',' + g + ') 3-TRAIL strategy would be ' + (100 * t3Crt1 / hCrt1 - 100).toFixed(1) + ' %' + ' MORE profitable than being HONEST.' : 'If (&alpha;,&gamma;) = (' + a + ',' + g + ') 3-TRAIL strategy would be ' + (100 - 100 * t3Crt1 / hCrt1).toFixed(1) + ' %' + ' LESS profitable than being HONEST.';
	var t4Badge = (100 * t4Crt1 / hCrt1 - 100) >= 0 ? 'If (&alpha;,&gamma;) = (' + a + ',' + g + ') 4-TRAIL strategy would be ' + (100 * t4Crt1 / hCrt1 - 100).toFixed(1) + ' %' + ' MORE profitable than being HONEST.' : 'If (&alpha;,&gamma;) = (' + a + ',' + g + ') 4-TRAIL strategy would be ' + (100 - 100 * t4Crt1 / hCrt1).toFixed(1) + ' %' + ' LESS profitable than being HONEST.';
	...
	pureCellVlues = {
		...
		t3dwc: t3Diff[1],
		t4dwc: t4Diff[1],
		edwc: equalForkDiff[1],
		hacd: honestDuration,
		sacd: selfishDuration,
		lacd: leadDuration,
		t2acd: t2Duration,
		t3acd: t3Duration,
		t4acd: t4Duration,
		eacd: equalForkDuration,
		htah: honestTheory[0],
		stah: selfishTheory[0],
		ltah: leadTheory[0],
		t2tah: t2Theory[0],
		t3tah: t3Theory[0],
		t4tah: t4Theory[0],
		etah: equalForkTheory[0],
		htpr: honestTheory[1],
		stpr: selfishTheory[1],
		ltpr: leadTheory[1],
		t2tpr: t2Theory[1],
		t3tpr: t3Theory[1],
		t4tpr: t4Theory[1],
		etpr: equalForkTheory[1],
		hCrt1: hCrt1,
		sCrt1: sCrt1,
		lCrt1: lCrt1,
		t2Crt1: t2Crt1,

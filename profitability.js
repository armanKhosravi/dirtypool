...
function theoreticalProfits(a, g, b, t, strategy, totalPublished, initialPoint) {
    ...
    switch (strategy) {
        case 's': // Selfish Mining Strategy
            ...
            break;
        case 'l': // Lead Mining Strategy
            var apparentHashrate = Math.floor((totalPublished + initialPoint) / 2016) < 1 ? a * ((1 - a + (1 - a) * a - a * a) / (1 - a + (1 - a) * a - a)) - (((1 - a) * a * (1 - a - a) * (1 - g)) / (g)) * ((1 - (1 - a) * (1 - g) * (2 / (1 + Math.sqrt(1 - 4 * (1 - g) * (1 - a) * a)))) / (1 - a + (1 - a) * a - a)) :
                    a - (((1 - a) * a * (1 - a - a) * (1 - g)) / g) * ((1 - (1 - a) * (1 - g) * (2 / (1 + Math.sqrt(1 - 4 * (1 - g) * (1 - a) * a)))) / (1 - a + (1 - a) * a - a));
